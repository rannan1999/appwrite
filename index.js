...
// 环境变量
const UUID = process.env.UUID || 'faacf142-dee8-48c2-8558-641123eb939c'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'l5GINS8lct8Egroitn';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
